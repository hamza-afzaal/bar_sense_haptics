...
public class HapticGrabber : MonoBehaviour 
{
    ...
    public bool isButtonOne()
    {
        return hapticDevice.GetComponent<HapticPlugin>().Buttons[0] == 1;
    }

    public bool isButtonTwo()
    {
        return hapticDevice.GetComponent<HapticPlugin>().Buttons[1] == 1;
    }
